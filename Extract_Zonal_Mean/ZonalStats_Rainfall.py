...
env.workspace =r"D:/01_Data/Rainfall/Rainfall_Atlas/daily/All_Islands_Daily_RF"

#Open Watershed Raster file (zones) and set output workspace
Wshds = "wshd/AlaWai_subwatershed_raster1.tif"
outws=r"G:/My Drive/Lab_Tsang/Project_SedimentFlux/SWAT/Zonal_AlaWai"

#get list of all raster grid files in my current directory
grd_List = arcpy.ListRasters()

for layer in grd_List[0:len(grd_List)-1]:   #len(grd_List)-1 while you put your watershed raster file at the same place
    print layer
    #Set Variables:
    inZoneData = Wshds
    zoneField = "Value"
