...
# genral
Date<-"20161026"         # YYYYMMDD
InjectionTime<-"14:29"   # Salt Injection time
LogInterval<-1           # YSI logging interval
Weather<-""
discharge_FlowMeter_cms<-0.0044
station<-"LYON"


# standard curve
StandardCurveTime<-"14:00"
...
Specific_Conductance_us.cm<-c(131.8,495.9,949,132.4)  # Sp. Conductance (us/cm)
Temperature_C<-c(21.8,22.1,21.8,21.8)   # Temperautre (degree C)
...
ysi<-read.csv(paste("./data/Salt_Injection_",Date,".csv",sep = ""))
